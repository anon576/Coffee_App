...
class Updatecoffee extends StatefulWidget {
  final String initialcoffeeName;
  final int initialcoffeePrice;
  final String initialcoffeeAuthor;
  final String initialcoffeeDesc;
  final String initialcoffeeImage;
  final String category;
  final int bid;

  const Updatecoffee({
    Key? key,
   required this.initialcoffeeName,
   required this.initialcoffeePrice,
   required this.initialcoffeeAuthor,
   required this.initialcoffeeDesc,
   required this.initialcoffeeImage,
...
class _UpdatecoffeeState extends State<Updatecoffee> {
  late TextEditingController coffeenamecontroller;
  late TextEditingController coffeepricecontroller;
  late TextEditingController coffeeauthorcontroller;
  late TextEditingController coffeedesccontroller;
  ...
  void initState() {
    super.initState();
    coffeenamecontroller = TextEditingController(text: widget.initialcoffeeName);
    coffeepricecontroller = TextEditingController(text: widget.initialcoffeePrice.toString());
    coffeeauthorcontroller =
        TextEditingController(text: widget.initialcoffeeAuthor);
    coffeedesccontroller = TextEditingController(text: widget.initialcoffeeDesc);
 ...
 Future<void> handleImagePicker(context,) async {
  ...
  Future<void> addcoffee() async {
    try {
      ...
      String base64Image = base64Encode(_bytes!);
        Map<dynamic,dynamic>   response = await CoffeeAPI.updatecoffee(
          bID: bid,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar.screenAppbar("Update coffee",context),
